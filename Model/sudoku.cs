...
namespace Sudoku
{
	...
	public class Sudoku
	{
		...
		public void GenerateGame(level.GameLevel level)
		{	
			InitialiseSet();
			int minPos,maxPos,noOfSets;			
			switch(level)
			{	case Sudoko.modal.level.GameLevel.Easy:
					minPos=4;
					maxPos=6;
					noOfSets=8;
					UnMask(minPos,maxPos,noOfSets);
					break;
				case Sudoko.modal.level.GameLevel.Medium:
					minPos=3;
					maxPos=5;
					noOfSets= 7;
					UnMask(minPos,maxPos,noOfSets);
					break;
				case Sudoko.modal.level.GameLevel.Hard:
					 minPos=3;
					 maxPos=5;
					noOfSets = 6;
					UnMask(minPos,maxPos,noOfSets);
